...
export const Interests: FC = () => {
  return (
    <>
      <div className="scroll_id" id="interests"></div>
      <section className="interests observer-section" data-id="interests">
        ...
        <div className="interests__list">
          <div className="interest-wrapper">
            ...
            <p className="interest-text">
              ...
              Doloribus est iure laborum magni neque nihil nostrum, nulla quam
              quia sint?
            </p>
            <p className="interest-text">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit.
          ...
          <div className="interest-wrapper">
            ...
            <p className="interest-text">
              ...
              commodi debitis doloremque, earum facilis illum molestiae
              molestias quis quisquam voluptatibus.
            </p>
            <p className="interest-text">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad
              commodi debitis doloremque, earum facilis illum molestiae
