    ...
    <Section scrollId={'about-me'} className={styles.aboutMe}>
      <div className="row">
        ...
        <div className="right">
          ...
          <p className="about-me__description gray">
            Все мы немножко fullstack...
          </p>

          <p className="about-me__description">
            Я веб-разработчик уровня middle+ со стажем 7 лет. Начинал свой путь
            с написания небольших сайтов для знакомых, успел поработать в
            стартапе (больше не хочу), попробовал множество языков
          ...
          <p className="about-me__description">
            ...
            . Тут я полюбил php, познакомился с React, научился работать в
            команде, активно общаться с &quot;бизнесом&quot;, обучать и
            управлять.
          </p>
          <p className="about-me__description">
          ...
          <ul className="about-me__extra">
            <li className="about-me__extra-element">
              ...
              <div className="about-me__extra-content">
                <span className="about-me__extra-title bold">
                  Дата рождения:
                </span>
            ...
            <li className="about-me__extra-element">
              ...
              <div className="about-me__extra-content">
                ...
                <span className="about-me__extra-description">
                  МАДИ(ГТУ), специальность - Автоматизированные системы
                  управления (АСУ)
                </span>
              </div>
            </li>
