...
export const Work: FC = () => {
  ...
  return (
    <>
      <div className="scroll_id" id="work"></div>
      <section className="work section-grey observer-section" data-id="work">
        <h2 className="second-title">Работа</h2>
            ...
            <div className="work-element__content">
              ...
              <ul className="work-element__projects">
                ...
                <li className="work-element__projects-element work-project">
                  ...
                  <div className="work-tooltip">
                    <p className="work-project__description">
                      Проект по навигационным карточкам с использованием
                      QR-кодов. Сервер на node.js, БД - sqlite3 + mongoDB
                    </p>
                  </div>
                </li>
                <li className="work-element__projects-element work-project">
                  ...
                  <div className="work-tooltip">
                    <p className="work-project__description">
                      Блог-интеграция с проектом BrandCheck. Реализация на
                      Django Framework
                    </p>
                  </div>
                </li>
